...
import { updateClientPhotoAction } from '@/app/actions/clients'
...
export function ClientPhotoUpload({
  ...
  async function handleFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    const path = `${tenantId}/${clientId}/foto-${Date.now()}.${ext}`
    ...
    const result = await updateClientPhotoAction(clientId, path)
    setUploading(false)
